...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      ...
      {/* Experience Timeline Section - Horizontal */}
      <ExperienceTimeline />

      {/* Projects Section with Click-to-Expand */}
      <ProjectsSection />
...
// Experience Timeline Component - Horizontal
function ExperienceTimeline() {
  ...
  const roles = [
    ...
    },
    {
      ...
      title: "Data Science Intern — Capital Markets",
  ...
  return (
    <section id="experience" className="min-h-screen py-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-center text-gray-400 mb-12">Click on any milestone to see full details</p>
        
        {/* Horizontal Timeline */}
        <div className="relative overflow-x-auto pb-12">
          <div className="flex items-center gap-8 px-8" style={{ width: 'max-content' }}>
            {/* Timeline Line */}
            <div className="absolute top-16 left-0 right-0 h-0.5 bg-gradient-to-r from-blue-500 via-purple-500 to-blue-500"></div>
            ...
            {roles.map((role, i) => (
              ...
              >
                {/* Dot */}
                <div className={`w-8 h-8 rounded-full border-4 border-slate-900 shadow-lg z-10 mb-4 transition-transform group-hover:scale-125 ${
                  role.type === "education" ? 'bg-purple-500' : 'bg-blue-500'
                }`}></div>
                ...
                <div className="w-40 text-center">
                  <img
                    src={role.logo}
                    alt={role.company}
                    className="w-12 h-12 mx-auto mb-2 object-contain rounded-lg bg-white p-1"
                  />
                  <p className="text-sm font-semibold mb-1">{role.shortTitle}</p>
          ...
          >
            ...
            <div className="flex items-start gap-4 mb-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-500">{selectedRole.date} — {selectedRole.dateEnd}</p>
              </div>
            </div>
